...
def insertImage(photo, pass_id, visit_date):
    try:
        ...
        sql_insert_blob_query = '''UPDATE  patient SET radio_picture = (%s) WHERE pass_id = (%s) AND visit_date = (%s) '''
...
def loadImage(pass_id,visit_date):
    ...
    try:
        ...
        for i in range(len(record)) :
            ...
            write_file(image, "output"+str(i)+".jpg")
